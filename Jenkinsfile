    ...
    stages {
        ...
        stage('Creating Chaos PacketLoss Scenarios') {
            ...
            steps {
                script {
                    scenario_id = sh (
                        script: "curl -s 'https://api.gremlin.com/v1/scenarios?teamId=${GREMLIN_TEAM_ID}' -H 'Content-Type: application/json;charset=utf-8' -H 'Authorization: Key ${GREMLIN_API_KEY}' -d '{\"name\":\"$ClusterName-$AttackType-$DeploymentName\" ,\"recommended_scenario_id\":\"\" ,\"graph\":{\"nodes\":{\"0\":{\"target_definition\":{\"target_type\":\"Kubernetes\" ,\"strategy_type\":\"Random\" ,\"strategy\":{\"attrs\":{} ,\"type\":\"RandomPercent\" ,\"percentage\":100} ,\"k8s_objects\":[{\"cluster_id\":\"$ClusterName\" ,\"uid\":\"$DeploymentUID\" ,\"namespace\":\"$Namespace\" ,\"name\":\"$DeploymentName\" ,\"kind\":\"DEPLOYMENT\" ,\"labels\":{} ,\"annotations\":{} ,\"available_containers\":[] ,\"target_type\":\"Kubernetes\"}] ,\"containerSelection\":{\"selectionType\":\"ANY\" ,\"containerNames\":[]}} ,\"impact_definition\":{\"infra_command_type\":\"packet_loss\" ,\"infra_command_args\":{\"cli_args\":[\"packet_loss\" ,\"-l\" ,\"$Packetloss_Length_First\" ,\"-h\" ,\"^api.gremlin.com\" ,\"-p\" ,\"^53\" ,\"-r\" ,\"$Packetloss_Percentage_First\" ,\"-s\", \"$Paketloss_Port\"] ,\"providers\":[] ,\"type\":\"packet_loss\"}} ,\"type\":\"InfraAttack\" ,\"id\":\"0\" ,\"next\":\"1\"} ,\"1\":{\"type\":\"Delay\" ,\"delay\":5 ,\"id\":\"1\" ,\"next\":\"2\"} ,\"2\":{\"target_definition\":{\"target_type\":\"Kubernetes\" ,\"strategy_type\":\"Random\" ,\"strategy\":{\"attrs\":{} ,\"type\":\"RandomPercent\" ,\"percentage\":100} ,\"k8s_objects\":[{\"cluster_id\":\"$ClusterName\" ,\"uid\":\"$DeploymentUID\" ,\"namespace\":\"$Namespace\" ,\"name\":\"$DeploymentName\" ,\"kind\":\"DEPLOYMENT\" ,\"labels\":{} ,\"annotations\":{} ,\"available_containers\":[] ,\"target_type\":\"Kubernetes\"}] ,\"containerSelection\":{\"selectionType\":\"ANY\" ,\"containerNames\":[]}} ,\"impact_definition\":{\"infra_command_type\":\"packet_loss\" ,\"infra_command_args\":{\"cli_args\":[\"packet_loss\" ,\"-l\" ,\"$Packetloss_Length_Second\" ,\"-h\" ,\"^api.gremlin.com\" ,\"-p\" ,\"^53\" ,\"-r\" ,\"$Packetloss_Percentage_Second\" ,\"-s\", \"$Paketloss_Port\"] ,\"providers\":[] ,\"type\":\"packet_loss\"}} ,\"type\":\"InfraAttack\" ,\"id\":\"2\" ,\"next\":\"3\"} ,\"3\":{\"type\":\"Delay\" ,\"delay\":5 ,\"id\":\"3\" ,\"next\":\"4\"} ,\"4\":{\"target_definition\":{\"target_type\":\"Kubernetes\" ,\"strategy_type\":\"Random\" ,\"strategy\":{\"attrs\":{} ,\"type\":\"RandomPercent\" ,\"percentage\":100} ,\"k8s_objects\":[{\"cluster_id\":\"$ClusterName\" ,\"uid\":\"$DeploymentUID\" ,\"namespace\":\"$Namespace\" ,\"name\":\"$DeploymentName\" ,\"kind\":\"DEPLOYMENT\" ,\"labels\":{} ,\"annotations\":{} ,\"available_containers\":[] ,\"target_type\":\"Kubernetes\"}] ,\"containerSelection\":{\"selectionType\":\"ANY\" ,\"containerNames\":[]}} ,\"impact_definition\":{\"infra_command_type\":\"packet_loss\" ,\"infra_command_args\":{\"cli_args\":[\"packet_loss\" ,\"-l\" ,\"$Packetloss_Length_Third\" ,\"-h\" ,\"^api.gremlin.com\" ,\"-p\" ,\"^53\" ,\"-r\" ,\"$Packetloss_Percentage_Third\" ,\"-s\", \"$Paketloss_Port\"] ,\"providers\":[] ,\"type\":\"packet_loss\"}} ,\"type\":\"InfraAttack\" ,\"id\":\"4\"}} ,\"start_id\":\"0\"}}' --compressed",
                        returnStdout: true
                        ).trim()
                        echo "********************************************************************************************************"                        
                        echo "Scenario id for this $AttackType pipeline is ${scenario_id}"                        
